    ...
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      ...
      <div className="flex flex-col gap-4 w-full sm:max-w-[480px] ">
        ...
        <div className="flex gap-3">
          ...
          <input type="text" className='border border-gray-300 rounded py-1.5 px-3.5 w-full' placeholder='State/Province' />
        </div>
        <div className="flex gap-3">
          ...
          <input type="phone" className='border border-gray-300 rounded py-1.5 px-3.5 w-full' placeholder='Phone Number'/>
      </div>
